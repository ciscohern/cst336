...
function getAllInventory(){
    ...
    $sql = "SELECT * FROM sneakers ORDER BY shoeID";
...
function getPriceInventory(){
    ...
    $sql = "SELECT * FROM sneakers ORDER BY price";
    ...
    <body>
	  ...
	  <?php
	    ...
	    foreach($inventory as $inventory) {
	        echo "<div>";
        	echo "<h3><a onclick=\"MoreInfo(" . $inventory['shoeID'] .")\">". $inventory['brand'] ." " . $inventory['model']." </a></h3><br />";
