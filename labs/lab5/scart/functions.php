    ...
    function displayCart(){
        ...
        if(isset($_SESSION['cart'])){
            ...
            foreach($_SESSION['cart'] as $item){
                ...
                echo "<inpit type = 'hidden' name = 'itemId' value = '$itemId'>";
    ...
    function displayResults(){
        ...
        if(isset($items)){
            ...
            foreach($items as $item){
                ...
                //Display table w/  add button
                echo '<tr>';
                echo "<td><img src = '$itemImage'></td>";
                echo "<td><h4>$itemName</h4></td>";
                echo "<td><h4>$itemPrice</h4></td>";
                
                //create hidden fields to send data
                echo "<form method = 'post'>";
                ...
                //check to see if the most recent POST request has the same ID
                //if so display different button
